 ...
 */
public class ParticipationEventList extends BaseForm{
    
    
     public ParticipationEventList(Resources res) {
    ...
    //    AjouterEvenement al = new AjouterEvenement(res);
       ...
       // ajouterButton.addActionListener(e -> nf.show());
...
//            });
            ...
            AjouterParticipation ml = new AjouterParticipation(res, evenement);
            // Create the "Update" button and add an ActionListener to handle updating the livreur
            Button updateButton = new Button("Participer");
