...
for ( Maintenance maintenance : Maintenance) {
    ...
    Label Etat = new Label("Etat: " + maintenance.getEtat());
      Label Id_vehicule = new Label("Id_vehicule: " + maintenance.getId_vehicule());
        Label Id_maintenance = new Label("Id_maintenance: " + maintenance.getId_maintenance());
   

    container.add(nom_sos_rep);
    container.add(Etat);
    container.add(Id_vehicule);
    container.add(Id_maintenance);
