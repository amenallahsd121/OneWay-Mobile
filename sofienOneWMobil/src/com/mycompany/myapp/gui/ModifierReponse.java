...
public class ModifierReponse extends BaseFormBack {
      ...
      public ModifierReponse(Resources res, Reponse reponse) {
       ...
       TextField Id_reclamationField = new TextField(String.valueOf(reponse.getId_reclamation()), "Id_reclamation", 40, TextField.ANY);
        ...
        Id_reclamationField.setUnselectedStyle(textFieldStyle);
        ...
        modifierButton.addActionListener(e -> {
            ...
            String id_reclamation = Id_reclamationField.getText();
            int id = Integer.parseInt(id_reclamation);

            // Create a new reclamation object with the new values
            Reponse newreponse = new Reponse(reponse.getId_reponse(), text_rep, id);
        ...
        addComponent(Id_reclamationField);
