...
for ( Vehicule Vehicule : vehicule) {
    ...
    Label Id_categorieLabel = new Label("Id_categorie : " + Vehicule.getId_categorie()); // declare the nomLabel variable and initialize it with the Label object
 // get the string value of the nomLabel object


    
   

    container.add(Id_categorieLabel);
