...
//       
//
//        ArrayList<Maintenance> M = ServiceMaintenance.getInstance().getAllMaintenance();
//        ArrayList<Vehicule> V = ServiceVehicule.getInstance().getAllVehicule();
//        
//        ArrayList<String> Matriculette = new ArrayList<>();
//        HashMap<Integer, String> mapTypes = new HashMap<>();
//        for (Vehicule v : V) {
//            Matriculette.add(v.getMatricule());
    // mapTypes.put(m.getMatricule(), m.getId_vehicule());
    // }
    public AjouterMaintenance(Resources res) {
        setTitle("Ajouter une Maintenance");
        setLayout(new BoxLayout(BoxLayout.Y_AXIS));
